...
export const metadata = {
  ...
  description:
    "Dashboard de KPIs, series temporales y reportes para equipos de negocio.",
};
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 space-y-16">
        ...
        <section className="space-y-3">
          ...
          <p className="text-lg text-gray-600">
            Dashboard interactivo de KPIs y reportes diseñado para equipos de
            negocio.
          </p>
          <p className="text-gray-600">
            Centraliza indicadores clave (tráfico, ventas, engagement y
            adquisición) en un único lugar, con visualizaciones claras y
        ...
        <section className="space-y-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card title="Ejecutivos">
              Visualiza los KPIs más relevantes de un vistazo para tomar
              decisiones rápidas.
            </Card>
        ...
        <section className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <span
                key={t}
                className="px-3 py-1 rounded-xl bg-brand-50 text-brand-700 text-sm font-medium shadow-sm border border-brand-100"
              >
                {t}
              </span>
            ))}
            <span className="px-3 py-1 rounded-xl bg-gray-100 text-gray-500 text-sm">
        ...
        <section className="text-center space-y-4">
          ...
          <p className="text-gray-600 text-sm">
            Datos de ejemplo — pronto: integración con Google Analytics y
            Shopify.
          </p>
          <Link
            href="/dashboard"
            className="inline-block px-5 py-2.5 rounded-xl bg-brand-600 text-white text-sm font-medium hover:bg-brand-700 transition-colors"
          >
            Ir al Dashboard
          </Link>
        </section>
...
function Card({
  ...
  return (
    <div className="bg-white border-l-4 border-brand-600 rounded-2xl shadow p-6 space-y-2">
...
function Li({ children }: { children: React.ReactNode }) {
  return <li className="bg-white rounded-xl shadow p-3 text-sm">{children}</li>;
}
